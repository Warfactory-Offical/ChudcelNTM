...
public class CustomLoreManager {
    ...
    static {
        ...
        addCustomLoreEntry("crystal_horn", true // TODO: MainRegistry.polaroidID == 11
                ? "An actual horn."
                : "Not an actual horn."
        );
        addCustomLoreEntry("crystal_charred", true // TODO: MainRegistry.polaroidID == 11
                ? "Also a real horn. Weird, right?"
                : "High quality silicate, slightly burned."
        );
        addCustomLoreEntry("key_red", true // TODO: MainRegistry.polaroidID == 11
                ? TextFormatting.DARK_RED + "" + TextFormatting.BOLD + "e"
                : "Explore the other side."
        );
        addCustomLoreEntry("ingot_neptunium", true // TODO: MainRegistry.polaroidID == 11
                ? "Woo, scary!"
