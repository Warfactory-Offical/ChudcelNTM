package com.chud.ntm.item.machine;
...
//        ModItems.get("ALL_ITEMS").add(this); // TODO??: uncomment, or perhaps not xd
    }

    public int getSpeed(){
        if(this == ModItems.get("upgrade_speed_1")) return 1;
        if(this == ModItems.get("upgrade_speed_2")) return 2;
        if(this == ModItems.get("upgrade_speed_3")) return 3;
        if(this == ModItems.get("upgrade_overdrive_1")) return 4;
        if(this == ModItems.get("upgrade_overdrive_2")) return 6;
        if(this == ModItems.get("upgrade_overdrive_3")) return 8;
        if(this == ModItems.get("upgrade_screm")) return 10;
        return 0;
    }
    ...
    public static int getSpeed(ItemStack stack){
        ...
        if(upgrade == ModItems.get("upgrade_speed_1")) return 1;
        if(upgrade == ModItems.get("upgrade_speed_2")) return 2;
        if(upgrade == ModItems.get("upgrade_speed_3")) return 3;
        if(upgrade == ModItems.get("upgrade_overdrive_1")) return 4;
        if(upgrade == ModItems.get("upgrade_overdrive_2")) return 6;
        if(upgrade == ModItems.get("upgrade_overdrive_3")) return 8;
        if(upgrade == ModItems.get("upgrade_screm")) return 10;
        return 0;
    }

    @Override
    public void addInformation(ItemStack stack, World worldIn, List<String> list, ITooltipFlag flagIn) {
        if(this == ModItems.get("upgrade_speed_1"))
        {
        ...
        if(this == ModItems.get("upgrade_speed_2"))
        {
            list.add(TextFormatting.GOLD+I18nUtil.resolveKey("desc.upgrade1"));
        ...
        if(this == ModItems.get("upgrade_speed_3"))
        {
            list.add(TextFormatting.GOLD+I18nUtil.resolveKey("desc.upgrade1"));
        ...
        if(this == ModItems.get("upgrade_effect_1"))
        {
            list.add(TextFormatting.GOLD+I18nUtil.resolveKey("desc.upgrade1"));
        ...
        if(this == ModItems.get("upgrade_effect_2"))
        {
            list.add(TextFormatting.GOLD+I18nUtil.resolveKey("desc.upgrade1"));
        ...
        if(this == ModItems.get("upgrade_effect_3"))
        {
            list.add(TextFormatting.GOLD+I18nUtil.resolveKey("desc.upgrade1"));
        ...
        if(this == ModItems.get("upgrade_power_1"))
        {
            list.add(TextFormatting.GOLD+I18nUtil.resolveKey("desc.upgrade2"));
        ...
        if(this == ModItems.get("upgrade_power_2"))
        {
            list.add(TextFormatting.GOLD+I18nUtil.resolveKey("desc.upgrade2"));
        ...
        if(this == ModItems.get("upgrade_power_3"))
        {
            list.add(TextFormatting.GOLD+I18nUtil.resolveKey("desc.upgrade2"));
        ...
        if(this == ModItems.get("upgrade_health"))
        {
...
//            Item.getItemFromBlock(ModBlocks.stone_gneiss), // TODO
            Items.FLINT,
            Items.SNOWBALL,
            Items.WHEAT_SEEDS,
            Items.STICK
