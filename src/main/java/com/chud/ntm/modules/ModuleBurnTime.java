...
import com.chud.ntm.util.ItemStackUtil;
...
public class ModuleBurnTime {
    ...
    public void readIfPresent(JsonObject obj) {
        modTime[modLog] = ILoadedTile.IConfigurableMachine.grab(obj, "D:timeLog", modTime[modLog]);
        modTime[modWood] = ILoadedTile.IConfigurableMachine.grab(obj, "D:timeWood", modTime[modWood]);
        modTime[modCoal] = ILoadedTile.IConfigurableMachine.grab(obj, "D:timeCoal", modTime[modCoal]);
        modTime[modLignite] = ILoadedTile.IConfigurableMachine.grab(obj, "D:timeLignite", modTime[modLignite]);
        modTime[modCoke] = ILoadedTile.IConfigurableMachine.grab(obj, "D:timeCoke", modTime[modCoke]);
        modTime[modSolid] = ILoadedTile.IConfigurableMachine.grab(obj, "D:timeSolid", modTime[modSolid]);
        modTime[modRocket] = ILoadedTile.IConfigurableMachine.grab(obj, "D:timeRocket", modTime[modRocket]);
        modTime[modBalefire] = ILoadedTile.IConfigurableMachine.grab(obj, "D:timeBalefire", modTime[modBalefire]);

        modHeat[modLog] = ILoadedTile.IConfigurableMachine.grab(obj, "D:heatLog", modHeat[modLog]);
        modHeat[modWood] = ILoadedTile.IConfigurableMachine.grab(obj, "D:heatWood", modHeat[modWood]);
        modHeat[modCoal] = ILoadedTile.IConfigurableMachine.grab(obj, "D:heatCoal", modHeat[modCoal]);
        modHeat[modLignite] = ILoadedTile.IConfigurableMachine.grab(obj, "D:heatLignite", modHeat[modLignite]);
        modHeat[modCoke] = ILoadedTile.IConfigurableMachine.grab(obj, "D:heatCoke", modHeat[modCoke]);
        modHeat[modSolid] = ILoadedTile.IConfigurableMachine.grab(obj, "D:heatSolid", modHeat[modSolid]);
        modHeat[modRocket] = ILoadedTile.IConfigurableMachine.grab(obj, "D:heatRocket", modHeat[modRocket]);
        modHeat[modBalefire] = ILoadedTile.IConfigurableMachine.grab(obj, "D:heatBalefie", modHeat[modBalefire]);
    }
